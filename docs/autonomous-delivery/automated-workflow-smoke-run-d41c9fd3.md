...
## Idea
- Title: Automated workflow smoke run
- Problem: The platform should move one idea through the workflow automatically.
- Outcome: Signals, opportunities, candidate ideas, delivery, execution, validation, and release artifacts should appear without manual intervention.

## Scope constraints
- Keep the flow bounded.

## Delivery linkage
- Goal: Automated workflow smoke run
- Plan: Automated workflow smoke run Delivery Plan
- Release candidate: 71172695-ff5e-4cbd-80dc-9a62b97357fe
